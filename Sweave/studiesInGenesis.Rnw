...
\begin{itemize}
  ...
  human government to adminsiter as His representative (Gen 9:5-6)
  \item Provides the raindbow as a symbol of His covenant not to
...
Note how this was problematic for several reaasons
