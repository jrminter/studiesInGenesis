...
\newcommand{\theTitle}{Studies in Genesis from the perspective of Christ Week 1 Notes} 
\newcommand{\theSubject}{Genesis} 
\newcommand{\theKeywords}{Sunday School, Genesis, Northgate}
\newcommand{\theDate}{March 2, 2014}
...
str.wd <- '~/work/proj/studiesInGenesis/wk01Notes/'
setwd(str.wd)
...
\subsection{Why this approach to Genesis?}
\begin{itemize}
  \item As I developed the outline for our series on Romans, I noted
  how Paul had placed a thesis statement early in the book, and then
	built an argument around it. I wondered if God might have done this
	for the Scriptures with Genesis, so began a study.
	\item I found some explicit statements from Christ that this was the
	case.
	\item As we will see during the quarter, there are many times the
	authors of the New Testament develop themes from Genesis.
	\item A verse by verse study of Genesis would probably take 2 years.
	We can visit key themes in one quarter.
\end{itemize}

\subsection{A word of caution}
We should always be watchful of pushing our ideas on the Scriptures.
This is called \emph{eisegesis} - reading into the text, instead of
\emph{exegesis} - getting our ideas \textbf{from} the text. However,
when we note that Christ and the New Testament authors have done this
under the control of the Spirit of God, we can be confident of their
conclusions. A wise friend summarized this with the statement,
``Scripture interprets Scripture.''

\subsection{Jesus's statements} 

\subsubsection{John 5:39--40}
Jesus rebuked unbelieving Jews concerning their handling
...
Note that Christ explicitly states that the Scriptures will point to
Him. We will see that this is true in Genesis.


\subsubsection{Lk 24:25--27}
...
Our objective for this quarter is to study several extended
passages in Genesis and see how God foretold Christ through
examples and types. Like we saw in Romans 1, effective authors
put forward their thesis early and develop the supporting structure
in subsequent chapters. Over the next quarter we will look through Genesis
for evidence of God's thesis concerning the work and ministry of Christ.
A recurring theme will be man's continued failure to consistently follow
God and the need for Christ for any hope. This will become evident when
we look at the character of the patriarchs and God's work in their lives.


\section{Creation Gen 1--2}

\subsection{Gen 1:1 - God's thesis statement for these chapters}
Moses present's God's thesis statement for Gen 1--2 in Gen 1:1.
Some have posited a ``gap'' between Gen 1:1 and Gen 1:2, but I think
seeing Gen 1:1 as a thesis that is developed in Gen 1:2-2:25 better
explains the text.

God claims here (and many other places) to have created all of what we
...
his cross. [Col 1:15--20, ESV].
\end{quotation}

\subsubsection{Heb 1:1--4}
...
excellent than theirs. [Heb 1:1--4, ESV].
\end{quotation}
...
they exchanged the truth for a lie and worship the creation rather than the
creator.

They will not accept evidence to the contrary. Unless Christ extends them
grace and opens their eyes, they
are doomed - for all their cosmology, and expensive instruments,
they are incapable of performing
the required experiment: going back, reproducing the process, and
invalidating their hypothesis\footnote{The naturalist philosopher of science,
...
\section{Gen 1:2--31: The six days of creation}
...
\textcolor{red}{What conclusions would God have us draw 
regarding His work of creation from this section?}

Remember, God expects Adam, Job, the apostle Paul, and you and me
to understand this. 

To obtain a correct answer, we need to look at where God begins,
the structure that He uses to communicate His message,
...
\subsubsection{Job Job 38:1--7 \ldots\ 40:3--5: Man's inability to discuss the details of creation}
